...
from .config import apply_settings, default_pricing_path, default_settings_path, workspace_storage_dir
...
from .sessions import find_chat_session_files, summarize
...
def snapshot(args: argparse.Namespace) -> tuple[Summary, Periods, Totals, PricingFile]:
    ...
    files = find_chat_session_files(args.workspace_storage.expanduser())
    summary = summarize(files, current_pricing)
